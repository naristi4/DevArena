...
export const en = {
  ...
  projectDetail: {
    ...
    additionalDocs:    "Attachments",
    noAttachments:     "No attachments yet",
    attachmentHint:    "Upload a file or add an external link (Figma, Notion, PRD…)",
    activity:          "Activity",
    badFileType:       "Unsupported file type.",
    fileTooLarge:      "File is too large.",
    uploadFile:        "Upload File",
    addLink:           "Add Link",
    addLinkTitle:      "Add External Link",
    linkName:          "Name",
    linkNamePlaceholder: "e.g. Figma Design",
    linkUrl:           "URL",
    linkUrlPlaceholder:  "https://…",
    linkInvalidUrl:    "Please enter a valid URL starting with https://",
    saving:            "Saving…",
    uploading:         "Uploading…",
